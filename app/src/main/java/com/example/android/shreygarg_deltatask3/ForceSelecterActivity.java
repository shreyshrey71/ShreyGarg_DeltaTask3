...
public class ForceSelecterActivity extends AppCompatActivity {

    RecyclerView detaillist;
    List<String> name = new Vector<String>();
    ForceSelecterAdapter forceSelecterAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        call.enqueue(new Callback<List<Forces>>() {
            ...
            public void onResponse(Call<List<Forces>> call, Response<List<Forces>> response) {
                ...
                forceSelecterAdapter.notifyDataSetChanged();
            }
        ...
        forceSelecterAdapter = new ForceSelecterAdapter(this, id, name,date);
        detaillist.setAdapter(forceSelecterAdapter);
    ...
    public void serchaction(String s) {
        ...
        if (!s.equals("")) {
            ...
            forceSelecterAdapter.notifyDataSetChanged();
            forceSelecterAdapter = new ForceSelecterAdapter(this, searchid, searchname,date);
            detaillist.setAdapter(forceSelecterAdapter);
        } else {
